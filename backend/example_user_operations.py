    ...
    try:
        ...
        async for session in sessionmanager.get_session():
            ...
            try:
                ...
                retrieved_user = await UserService.get_user_by_id(session, new_user.user_id)
                if retrieved_user:
                ...
                user_by_email = await UserService.get_user_by_email(session, "john.doe@example.com")
                if user_by_email:
                ...
                user_by_username = await UserService.get_user_by_username(session, "johndoe")
                if user_by_username:
                ...
                if wrong_auth:
                    print("❌ This shouldn't happen - authentication with wrong password succeeded")
                else:
                ...
                print("This might happen if you run the script multiple times with the same email/username")
