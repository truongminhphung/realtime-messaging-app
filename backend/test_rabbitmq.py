...
from realtime_messaging.services.rabbitmq import rabbitmq_service, publish_message_notification
...
async def test_rabbitmq_notifications():
    ...
    try:
        ...
        error_result = await notification_worker.process_notification(malformed_notification)
        if error_result:
